...
fn main() {
    ...
    machine.add_transition(
        ...
        |_, _| println!("[info] PPTP-Start-Control-Connection-Request detected!"),
    );
    machine.add_transition(
        State::Detected_Level1,
        Event::PPTP_Start_Control_Connection_Reply,
        State::Detected_Level2,
        |_, _| println!("[info] PPTP-Start-Control-Connection-Reply detected!"),
    );
    machine.add_transition(
        State::Detected_Level2,
        Event::PPTP_Outgoing_Call_Request,
        State::Detected_Level3,
        |_, _| println!("[info] PPTP-Outgoing-Call-Request detected!"),
    );
    machine.add_transition(
        State::Detected_Level3,
        Event::PPTP_Outgoing_Call_Reply,
        State::Confirmed,
        |_, _| println!("[info] PPTP-Outgoing-Call-Reply detected!"),
    );
